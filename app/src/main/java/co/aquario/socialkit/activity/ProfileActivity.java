 ...
 * @date 2014-04-30
 */
public class ProfileActivity extends ActionBarActivity implements PullScrollView.OnTurnListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FeedFragment feedFragment = new FeedFragment().newInstance("hey");

        ViewPagerFragment fragment = new ViewPagerFragment();
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        transaction.replace(R.id.sub_container, feedFragment);
        transaction.commit();
        ...
        for (int i = 0; i < 30; i++) {
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(ProfileActivity.this, "Click item " + n, Toast.LENGTH_SHORT).show();
                }
            });
