...
import co.aquario.socialkit.fragment.ItemFragment;
...
public class ItemListAdapter extends RecyclerView.Adapter<ItemListAdapter.ItemHolder> {
    ...
    ArrayList<ProductAquery> productses = new ArrayList<>();
    public Context context;
    public ItemListAdapter(ArrayList<ProductAquery> productses, Context context) {
