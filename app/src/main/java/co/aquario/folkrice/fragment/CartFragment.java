...
import co.aquario.folkrice.model.DataSource;
...
public class CartFragment extends DialogFragment {
    ...
    private class ItemAdapter extends ArrayAdapter<ProductAquery> {

        public ItemAdapter(ArrayList<ProductAquery> items) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ProductAquery i = mCart.get(position);
