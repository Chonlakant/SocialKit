...
public class ProductAdapter extends BaseAdapter {
    ...
    private List<ProductAquery> mProductList;
    private LayoutInflater mInflater;
    private boolean mShowQuantity;

    Context context;

    public ProductAdapter(List<ProductAquery> list, LayoutInflater inflater, boolean showQuantity, Context context) {
        mProductList = list;
        mInflater = inflater;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ProductAquery curProduct = mProductList.get(position);
